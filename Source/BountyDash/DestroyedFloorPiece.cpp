...
ADestroyedFloorPiece::ADestroyedFloorPiece()
{
	...
	ConstructorHelpers::FObjectFinder<UDestructibleMesh>myDestMesh(TEXT("/Game/Destroyable_Mesh_DM.Destroyable_Mesh_DM"));
...
// UWorld *AAcot::GetWorld() const *Getter for the cached world pointer
